...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_buefy__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Tasks_vue__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Tasks_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_Tasks_vue__);
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_0_buefy___default.a, { defaultIconPack: 'fa' });

var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
    el: '#app',
    components: {
        tasks: __WEBPACK_IMPORTED_MODULE_2__components_Tasks_vue___default.a
    }
});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(1).setImmediate))
...
Component.options.__file = "app/components/Tasks.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fa35a71e", Component.options)
  } else {
    hotAPI.reload("data-v-fa35a71e", Component.options)
' + '  }
...
var update = __webpack_require__(19)("42cca545", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fa35a71e\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Tasks.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fa35a71e\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Tasks.vue");
...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.common['X-CSRF-Token'] = csrfToken;
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getInitialData: function getInitialData() {
      ...
      var getters = [this.urls.categories, this.urls.tasks].map(function (url) {
        return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(url);
      });

      var loadingComponent = this.$loading.open();
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.all(getters).then(__WEBPACK_IMPORTED_MODULE_0_axios___default.a.spread(function (categoriesResponse, tasksResponse) {
        loadingComponent.close();
        _this.categories = categoriesResponse.data.data;
        _this.tasks = tasksResponse.data.data;
    ...
    fetchTasks: function fetchTasks() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.urls.tasks).then(function (response) {
    ...
    fetchCategories: function fetchCategories() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.urls.categories).then(function (response) {
    ...
    storeTask: function storeTask() {
      ...
      var payload = _extends({}, this.task);
      var loadingComponent = this.$loading.open();
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(this.urls.tasks, payload).then(function (response) {
        loadingComponent.close();
        _this4.$toast.open({
          type: "is-success",
          message: "Task saved!"
        ...
        _this4.$toast.open({
          type: "is-danger",
          message: error.response && error.response.data.message ? error.response.data.message : "An unexpected error occured, task not saved."
        });
        console.log(error);
      });
    },
    toggleDone: function toggleDone(task) {
      ...
      var payload = _extends({}, task);
      var url = this.urls.tasks + '/' + payload.id;
      var loadingComponent = this.$loading.open();

      payload.done = !payload.done;
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(url, payload).then(function (response) {
        loadingComponent.close();
        _this5.fetchTasks();
      }).catch(function (error) {
        _this5.$toast.open({
          type: "is-danger",
          message: error.response && error.response.data.message ? error.response.data.message : "An unexpected error occured, action failed."
        });
        console.log(error);
      });
    },
      ...
      this.$dialog.prompt({
        ...
        onConfirm: function onConfirm(value) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(_this6.urls.categories, { name: value }).then(function (response) {
            ...
            _this6.$toast.open("New category added!");
          }).catch(function (error) {
            loadingComponent.close();
            console.log(error);
          });
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "panel" },
    [
      _c("p", { staticClass: "panel-heading" }, [_vm._v("\n    Tasks\n  ")]),
      _vm._v(" "),
      _c(
        "div",
          ...
          _c(
            ...
            [
              ...
              _c(
                "b-select",
                {
                  attrs: { placeholder: "Pick a category", required: "" },
                  model: {
                    value: _vm.task.category_id,
                    callback: function($$v) {
                      _vm.$set(_vm.task, "category_id", $$v)
                    },
                    expression: "task.category_id"
                  }
                },
      ...
      _vm._l(_vm.pendingTasks, function(task) {
        return _c("label", { key: task.id, staticClass: "panel-block" }, [
          _c("input", {
            attrs: { type: "checkbox" },
            on: {
              click: function($event) {
      ...
      _vm._l(_vm.completedTasks, function(task) {
        return _c(
          ...
          {
            key: task.id,
            staticClass: "panel-block has-text-grey-lighter has-line-through"
          },
          [
            _c("input", {
              attrs: { type: "checkbox" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-fa35a71e", module.exports)
  }
}
