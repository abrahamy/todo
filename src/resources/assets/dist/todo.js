...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugin__ = __webpack_require__(24);




__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2__plugin__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tasks_vue__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tasks_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Tasks_vue__);


var components = [__WEBPACK_IMPORTED_MODULE_0__Tasks_vue___default.a];
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getInitialData: function getInitialData() {
      ...
      var getters = [this.urls.categories, this.urls.tasks].map(this.$axios.get);

      var loadingComponent = this.$loading.open();
      this.$axios.all(getters).then(this.$axios.spread(function (categoriesResponse, tasksResponse) {
    ...
    fetchTasks: function fetchTasks() {
      ...
      this.$axios.get(this.urls.tasks).then(function (response) {
    ...
    fetchCategories: function fetchCategories() {
      ...
      this.$axios.get(this.urls.categories).then(function (response) {
    ...
    storeTask: function storeTask() {
      ...
      var loadingComponent = this.$loading.open();
      this.$axios.post(this.urls.tasks, payload).then(function (response) {
        loadingComponent.close();
        _this4.$toast.open({
          type: "is-success",
          message: "Task saved!"
    ...
    toggleDone: function toggleDone(task) {
      ...
      this.$axios.put(url, payload).then(function (response) {
        loadingComponent.close();
        _this5.fetchTasks();
      }).catch(function (error) {
        _this5.$toast.open({
    ...
    createCategory: function createCategory() {
      ...
      this.$dialog.prompt({
        ...
        onConfirm: function onConfirm(value) {
          ...
          _this6.$axios.post(_this6.urls.categories, { name: value }).then(function (response) {
            loadingComponent.close();
...
var debugMode = function debugMode(Vue) {
  if (true) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  install: function install(Vue) {
    Vue.use(__WEBPACK_IMPORTED_MODULE_1_buefy___default.a, { defaultIconPack: 'fa' });
    installAxios(Vue);
    debugMode(Vue);
  }
});
